...
const replaceWords = (str) => {
    ...
    // i => we
    let iIndex = wordsArray.indexOf("I");
    if (iIndex !== -1) {
        wordsArray.splice(iIndex, 1, "We");
    }
    // am => are
    let amIndex = wordsArray.indexOf("am");
    if (amIndex !== -1) {
        wordsArray.splice(amIndex, 1, "are");
    }
    //was => were
    let wasIndex = wordsArray.indexOf("was");
    if (wasIndex !== -1) {
        wordsArray.splice(wasIndex, 1, "were");
    }
